...
class PauseMenu:
    def __init__(self,screen):
        self.screen = screen
        self.text = pygame.font.Font(font,25)

        self.paused = self.text.render("Game Paused!",False,"#AAAAAA")
        self.pauseRect = self.paused.get_rect(center = (SCREENWIDTH//2,100))
        

    def update(self):
        self.screen.blit(self.paused,self.pauseRect)