...
class Level:
    def __init__(self,screen):
        ...
        self.player = Player(self.playerPos,[self.visibleSprites],self.changeRoom,self.collisionSprites)
                ...
                for colIndex,col in enumerate(row):
                    if col != "-1":
                        ...
                        if type == "objects":
                            ...
                            if col == "14":
                                Spike((x,y-12),[self.visibleSprites,self.harmSprites,self.worldSprites,self.trapSprites],self.player)
                            if col == "15":
